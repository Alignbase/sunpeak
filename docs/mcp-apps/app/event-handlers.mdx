...
| `structuredContent` | `unknown` | JSON data optimized for UI rendering |
...
<Note>
  This is the SDK 1.x schema-keyed form. SDK 2.0 keys handlers by method name and keeps this form
  only as a deprecated overload. See [Update Custom Protocol
  Handlers](/mcp-apps/sdk-v2-migration#update-custom-protocol-handlers).
</Note>
