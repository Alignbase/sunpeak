...
<Note>
  This View-to-Host method remains part of the MCP Apps `2026-01-26` protocol. Core MCP
  `2026-07-28` deprecated Sampling for new client and server implementations and replaced the
  standalone server-to-client request with MRTR, but that does not remove the MCP Apps View API.
  See [MCP 2026-07-28 for MCP Apps](/mcp-apps/mcp/2026-07-28#server-to-client-requests-use-mrtr).
</Note>
