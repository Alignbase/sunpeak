...
Use ext-apps 2.0 for new work. Current sunpeak releases install it with the split MCP SDK 2.0 packages and Zod 4.2 or newer. The View-to-Host wire protocol remains `2026-01-26`, so 1.x and 2.x Views and Hosts can communicate. See the [MCP Apps SDK 2.0 Migration Guide](/mcp-apps/sdk-v2-migration) for install commands and TypeScript changes.
</Accordion>
