...
<Note>
  This reference covers MCP Apps SDK v1.7.5, which sunpeak 0.20.x uses. Version 2.0 keeps the
  same View protocol but changes peer packages, deprecates the union types below, and broadens
