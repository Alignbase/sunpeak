...
| MCP Apps SDK package | Upstream: `2.0.0`; sunpeak 0.20.x: `1.7.5`           | `package.json`                                        | The implementation, peer dependencies, and TypeScript APIs          |
...
sunpeak 0.20.x uses ext-apps 1.7.5 and the monolithic MCP SDK 1.30. Keep those framework dependencies together. Standalone projects can use the [MCP Apps SDK 2.0 Migration Guide](/mcp-apps/sdk-v2-migration) to move to the split packages.
