...
<Note>
  sunpeak 0.20.x uses core MCP `2025-11-25`, so the lifecycle examples on this page show
  that revision. The current core specification is `2026-07-28`, which uses self-contained
  requests instead of the handshake and protocol session shown below. See [MCP 2026-07-28 for
  MCP Apps](/mcp-apps/mcp/2026-07-28).
</Note>
