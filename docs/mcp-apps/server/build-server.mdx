...
<Note>
  This server example uses the split MCP SDK 2.0 packages and `z.object()` schemas used by current
  sunpeak releases. See the [SDK 2.0 migration guide](/mcp-apps/sdk-v2-migration) when updating a
  1.x server.
</Note>
