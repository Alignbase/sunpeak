...
For schema library requirements, runtime validation behavior, and examples for server and
app-side tools, see [MCP App inputSchema and outputSchema
Validation](/mcp-apps/server/tool-schemas).
...
<CardGroup cols={2}>
  ...
  <Card title="Tool Schemas" icon="brackets-curly" href="/mcp-apps/server/tool-schemas">
    Define and validate inputSchema and outputSchema contracts.
  </Card>
</CardGroup>
