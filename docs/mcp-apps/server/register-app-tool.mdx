...
Use `z.object()` for input and output schemas. SDK 2.0 still accepts raw Zod shapes, but that overload is deprecated. See the [SDK 2.0 migration guide](/mcp-apps/sdk-v2-migration#wrap-tool-schemas-with-zobject).
