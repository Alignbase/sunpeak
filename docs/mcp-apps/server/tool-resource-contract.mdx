...
If you want a shorter pre-ship checklist that covers fallback behavior, security metadata, host testing, and review readiness, use [MCP App Requirements Checklist](/mcp-apps/server/requirements).
...
| `structuredContent` | Model, host, View, and typed clients | Put model-safe data your UI renders here. If you declare `outputSchema`, this value must match it. See the [protocol-version rules](/mcp-apps/server/content-structuredcontent-meta#json-values-and-protocol-versions). |
...
<Card horizontal title="Build an MCP App Server" icon="page" href="/mcp-apps/server/build-server">
...
<Card horizontal title="Requirements Checklist" icon="page" href="/mcp-apps/server/requirements">
  Verify portability, fallback behavior, security metadata, annotations, and tests before shipping.
</Card>

<Card horizontal title="Tool Results and Model Context" icon="page" href="/mcp-apps/server/tool-results-model-context">
  Decide what belongs in content, structuredContent, _meta, and updateModelContext.
</Card>

<Card horizontal title="content vs structuredContent vs _meta" icon="page" href="/mcp-apps/server/content-structuredcontent-meta">
  Choose the right tool result data channel.
</Card>

<Card horizontal title="Tool Annotations" icon="page" href="/mcp-apps/server/tool-annotations">
