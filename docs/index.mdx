...
keywords: ["MCP Apps", "ChatGPT Apps", "ChatGPT plugins", "MCP app framework", "ChatGPT app framework", "Claude Apps", "Claude Connectors", "sunpeak"]
---
...
<Tabs>
  ...
  <Tab title="yarn">
    ```bash
    yarn dlx skills add Alignbase/sunpeak@create-sunpeak-app Alignbase/sunpeak@test-mcp-server
    ```
  </Tab>
</Tabs>
</Tip>
...
<video
  ...
  alt="sunpeak inspector demo"
  aria-label="sunpeak inspector demo"
  title="sunpeak inspector demo"
  autoPlay
  muted
  loop
  playsInline
